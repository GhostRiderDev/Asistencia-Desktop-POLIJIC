...
namespace DGVPrinterHelper //AllocationRequest / Solicitud de asignación
{    
    ...
    /// / Impresora de vista de cuadrícula de datos. Funciones de impresión para una vista de cuadrícula de datos, desde MS
    ...
    public class DGVPrinter
    {
        ...
        /// </summary>
        private System.Drawing.Font subtitlefont;
        public System.Drawing.Font SubTitleFont
        {
        ...
        public void ExportDiataToExcel(DataGridView dgv)
        {
        using (SaveFileDialog sfd = new SaveFileDialog())
        {
            sfd.Filter = "Excel Files|*.xlsx";
            sfd.Title = "ReporteIngresosPoliCJIC";
            string fileName = "ReportesIngresos" + "-" + DateTime.Now.ToString("dd_MM_yy-HH:mm") + ".xlsx";
            string validFileName = fileName.Replace(":", "_");
            sfd.FileName = validFileName;
                ...
                using (var workbook = new XLWorkbook())
                {
                    var worksheet = workbook.Worksheets.Add("Ingresos");
                        ...
                        for (int i = 0; i < dgv.Columns.Count; i++)
                        {
                            ...
                            worksheet.Column(i + 1).Width = dgv.Columns[i].Width / 7.0; // Ajustar el factor de división según sea necesario
                    }
                        ...
                        for (int i = 0; i < dgv.Rows.Count; i++)
                        {
                            for (int j = 0; j < dgv.Columns.Count; j++)
                            {
                                ...
                                // Aplicar formato condicional según el tipo de datos
                                if (dgv.Columns[j].ValueType == typeof(int) || dgv.Columns[j].ValueType == typeof(double))
                                {
